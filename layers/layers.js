...
lyr_SaranaPrasarana_33.set('fieldAliases', {'No_': 'No_', 'nama_titik': 'nama_titik', 'X': 'X', 'Y': 'Y', 'FOTO': 'FOTO', 'PHOTO': 'PHOTO', });
...
lyr_KantorResortdanKantorSeksi_17.set('fieldImages', {'No_': 'TextEdit', 'nama_titik': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'FOTO': 'TextEdit', 'PHOTO': 'TextEdit', 'jenis': 'TextEdit', });
...
lyr_SaranaPrasarana_33.set('fieldImages', {'No_': 'TextEdit', 'nama_titik': 'TextEdit', 'X': 'TextEdit', 'Y': 'TextEdit', 'FOTO': 'TextEdit', 'PHOTO': 'ExternalResource', });
...
lyr_SaranaPrasarana_33.set('fieldLabels', {'No_': 'inline label', 'nama_titik': 'inline label', 'X': 'inline label', 'Y': 'inline label', 'FOTO': 'inline label', 'PHOTO': 'inline label', });
lyr_SaranaPrasarana_33.on('precompose', function(evt) {
